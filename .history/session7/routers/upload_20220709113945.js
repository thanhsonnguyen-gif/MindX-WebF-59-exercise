...
router.post(
  ...
  async (req, res) => {
    ...
    } else if (reportsId === undefined) {
      let fieldReportId = { reportsId: [newReport.insertedId] };
      // let fieldReportsIdWithValue = fieldReportId.push(newReport.insertedId);
      // console.log(`1:${fieldReportId}, 2:${newReport.insertedId}, 3:${fieldReportsIdWithValue}`);
      // console.log(fieldReportId, newReport.insertedId, fieldReportsIdWithValue);
      console.log(fieldReportId);
      await UserCtrl.updateUserInfo(req.user._id, fieldReportId);
    } else {
